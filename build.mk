...
${bin_dir}/example_exec: ${lib_dir}/libacme-skeleton-static.a   # depends on building the static library
${bin_dir}/example_exec: LIBS += acme-skeleton-static  # link this executable to this static library
...
${test_dir}/test_example: ${lib_dir}/libacme-skeleton-shared.so  # depends on building the shared library
